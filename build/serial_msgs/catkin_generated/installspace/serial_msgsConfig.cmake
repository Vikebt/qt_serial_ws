...
if("FALSE" STREQUAL "TRUE")
  set(serial_msgs_SOURCE_PREFIX /home/wheeltec/qt_serial_ws_251216/src/serial_msgs)
  set(serial_msgs_DEVEL_PREFIX /home/wheeltec/qt_serial_ws_251216/devel)
  ...
  set(serial_msgs_INSTALL_PREFIX /home/wheeltec/qt_serial_ws_251216/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'serial_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT serial_msgs_NUM_DUMMY_TARGETS)
      set(serial_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::serial_msgs::wrapped-linker-option${serial_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR serial_msgs_NUM_DUMMY_TARGETS "${serial_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::serial_msgs::wrapped-linker-option${serial_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND serial_msgs_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(serial_msgs_EXPORTED_TARGETS ${${serial_msgs_dep}_EXPORTED_TARGETS})
endforeach()
