...
if(window_control_CONFIG_INCLUDED)
  return()
endif()
set(window_control_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(window_control_SOURCE_PREFIX /home/wheeltec/qt_serial_ws_251216/src/mainwindow)
  set(window_control_DEVEL_PREFIX /home/wheeltec/qt_serial_ws_251216/devel)
  set(window_control_INSTALL_PREFIX "")
  set(window_control_PREFIX ${window_control_DEVEL_PREFIX})
else()
  set(window_control_SOURCE_PREFIX "")
  set(window_control_DEVEL_PREFIX "")
  set(window_control_INSTALL_PREFIX /home/wheeltec/qt_serial_ws_251216/install)
  set(window_control_PREFIX ${window_control_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'window_control' is deprecated")
...
set(window_control_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(window_control_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'leon <leon@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${window_control_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'window_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'window_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(window_control_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND window_control_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND window_control_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT window_control_NUM_DUMMY_TARGETS)
      set(window_control_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::window_control::wrapped-linker-option${window_control_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR window_control_NUM_DUMMY_TARGETS "${window_control_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::window_control::wrapped-linker-option${window_control_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND window_control_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(window_control_LIBRARY_DIRS ${lib_path})
      list(APPEND window_control_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'window_control'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND window_control_LIBRARIES ${lib})
    endif()
  endif()
...
set(window_control_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${window_control_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 window_control_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${window_control_dep}_FOUND)
      find_package(${window_control_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${window_control_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(window_control_INCLUDE_DIRS ${${window_control_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(window_control_LIBRARIES ${window_control_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${window_control_dep}_LIBRARIES})
  _list_append_deduplicate(window_control_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(window_control_LIBRARIES ${window_control_LIBRARIES})

  _list_append_unique(window_control_LIBRARY_DIRS ${${window_control_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(window_control_EXPORTED_TARGETS ${${window_control_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${window_control_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
