...
if(lslidar_ls_driver_CONFIG_INCLUDED)
  return()
endif()
set(lslidar_ls_driver_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lslidar_ls_driver_SOURCE_PREFIX /home/wheeltec/qt_serial_ws_251216/src/lslidar_ls_driver)
  set(lslidar_ls_driver_DEVEL_PREFIX /home/wheeltec/qt_serial_ws_251216/devel)
  set(lslidar_ls_driver_INSTALL_PREFIX "")
  set(lslidar_ls_driver_PREFIX ${lslidar_ls_driver_DEVEL_PREFIX})
else()
  set(lslidar_ls_driver_SOURCE_PREFIX "")
  set(lslidar_ls_driver_DEVEL_PREFIX "")
  set(lslidar_ls_driver_INSTALL_PREFIX /home/wheeltec/qt_serial_ws_251216/install)
  set(lslidar_ls_driver_PREFIX ${lslidar_ls_driver_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lslidar_ls_driver' is deprecated")
...
set(lslidar_ls_driver_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/wheeltec/qt_serial_ws_251216/devel/include;/home/wheeltec/qt_serial_ws_251216/src/lslidar_ls_driver/include " STREQUAL " ")
  set(lslidar_ls_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/wheeltec/qt_serial_ws_251216/devel/include;/home/wheeltec/qt_serial_ws_251216/src/lslidar_ls_driver/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'leo <zufanglei@lslidar.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lslidar_ls_driver_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lslidar_ls_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lslidar_ls_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wheeltec/qt_serial_ws_251216/src/lslidar_ls_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lslidar_ls_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lslidar_ls_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lslidar_ls_driver_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lslidar_ls_driver_NUM_DUMMY_TARGETS)
      set(lslidar_ls_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lslidar_ls_driver::wrapped-linker-option${lslidar_ls_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lslidar_ls_driver_NUM_DUMMY_TARGETS "${lslidar_ls_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lslidar_ls_driver::wrapped-linker-option${lslidar_ls_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lslidar_ls_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(lslidar_ls_driver_LIBRARY_DIRS ${lib_path})
      list(APPEND lslidar_ls_driver_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lslidar_ls_driver'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lslidar_ls_driver_LIBRARIES ${lib})
    endif()
  endif()
...
set(lslidar_ls_driver_EXPORTED_TARGETS "lslidar_ls_driver_generate_messages_cpp;lslidar_ls_driver_generate_messages_eus;lslidar_ls_driver_generate_messages_lisp;lslidar_ls_driver_generate_messages_nodejs;lslidar_ls_driver_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lslidar_ls_driver_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;nodelet;pcl_ros;pcl_conversions;std_msgs;sensor_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 lslidar_ls_driver_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lslidar_ls_driver_dep}_FOUND)
      find_package(${lslidar_ls_driver_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lslidar_ls_driver_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lslidar_ls_driver_INCLUDE_DIRS ${${lslidar_ls_driver_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lslidar_ls_driver_LIBRARIES ${lslidar_ls_driver_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lslidar_ls_driver_dep}_LIBRARIES})
  _list_append_deduplicate(lslidar_ls_driver_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lslidar_ls_driver_LIBRARIES ${lslidar_ls_driver_LIBRARIES})

  _list_append_unique(lslidar_ls_driver_LIBRARY_DIRS ${${lslidar_ls_driver_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(lslidar_ls_driver_EXPORTED_TARGETS ${${lslidar_ls_driver_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "lslidar_ls_driver-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lslidar_ls_driver_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
