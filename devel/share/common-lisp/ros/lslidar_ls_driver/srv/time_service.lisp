...
(cl:defmethod cl:initialize-instance :after ((m <time_service-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'time_service-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lslidar_ls_driver-srv:<time_service-request> is deprecated: use lslidar_ls_driver-srv:time_service-request instead.")))

(cl:ensure-generic-function 'time_service_mode-val :lambda-list '(m))
(cl:defmethod time_service_mode-val ((m <time_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lslidar_ls_driver-srv:time_service_mode-val is deprecated.  Use lslidar_ls_driver-srv:time_service_mode instead.")
  (time_service_mode m))

(cl:ensure-generic-function 'ntp_ip-val :lambda-list '(m))
(cl:defmethod ntp_ip-val ((m <time_service-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lslidar_ls_driver-srv:ntp_ip-val is deprecated.  Use lslidar_ls_driver-srv:ntp_ip instead.")
  (ntp_ip m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<time_service-request>)))
  ...
  "lslidar_ls_driver/time_serviceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'time_service-request)))
  "Returns string type for a service object of type 'time_service-request"
  "lslidar_ls_driver/time_serviceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <time_service-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'time_service-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lslidar_ls_driver-srv:<time_service-response> is deprecated: use lslidar_ls_driver-srv:time_service-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<time_service-response>)))
  ...
  "lslidar_ls_driver/time_serviceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'time_service-response)))
  "Returns string type for a service object of type 'time_service-response"
  "lslidar_ls_driver/time_serviceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'time_service)))
  ...
  "lslidar_ls_driver/time_service")