...
extern float result_lon;
extern float result_lat;

extern std::string path_load;     //加载基准图路径
extern std::string path_save;     //存储文件夹
...
//飞行高度及物面分辨率倍数
extern const int para_maxheight; // 无人机相对地面高度，必须小于此高度，单位米
extern const int para_minheight; 	 // 无人机相对地面高度，必须大于此高度，单位米
extern const int para_ratio;       // 基准图物面分辨率 / 实时图像物面分辨率，最大倍数

//实时图像灰度及方差
extern const int para_minstd;		// 图像最低方差
extern const int para_mingray;	// 图像最低平均灰度
extern const int para_maxgray;	// 图像最高平均灰度

//光轴与铅垂线夹角
extern const int para_maxdev;		// 相机光轴相对铅垂线倾角，必须小于此值
extern const int para_cutdev;		// 相机光轴相对铅垂线倾角，大于此值，则只取图像下半部分参数
...
///////////////////////////////////////
extern struct BaseImgInfo lastbd;
